const buttonClone = new CreateElm(createHtmlElm("button"),"button","buttonData",["resize","drag","alter","remove"]);
cloneFunc.cloneHtml(buttonClone);
saveFunc.saveElm(buttonClone).removeElm(buttonClone);
updateFunc.updateSize(buttonClone);
updateFunc.updateDrag(buttonClone);
